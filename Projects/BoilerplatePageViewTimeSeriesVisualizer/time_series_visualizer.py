...
df = pd.read_csv(
    'Projects/BoilerplatePageViewTimeSeriesVisualizer/fcc-forum-pageviews.csv', 
    index_col='date', 
    parse_dates=['date']
    )
...
def draw_bar_plot():
    ...
    fig = df_bar.plot.bar(figsize= (12,12), xlabel = 'Years', ylabel = 'Average Page Views', legend=True).figure
